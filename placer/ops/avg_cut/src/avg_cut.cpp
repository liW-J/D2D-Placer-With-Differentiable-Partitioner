 ...
 * @LastEditTime: 2025-04-24 13:06:48
...
void tier_assign(T *tier, const T *x, const T *y, const int *flat_netpin, const int *netpin_start,
                 const int *pin2node_map, int num_movable_nodes, int num_nets, int num_tiers, const T *node_size_x, const T *node_size_y)
{
...
at::Tensor avg_cut_forward(at::Tensor flat_netpin, at::Tensor netpin_start,
                           ...
                           int num_movable_nodes, at::Tensor pos, at::Tensor node_size_x, at::Tensor node_size_y)
{
