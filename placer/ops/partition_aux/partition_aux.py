...
LastEditTime: 2025-06-13 18:02:51
...
class PartitionAuxFunction(Function):
    ...
    def forward(tier, flat_netpin, netpin_start, pin2node_map, net_weights,
                ...
                net_names, terminal_names, pos_2d):
...
class PartitionAux(object):
    ...
    def __call__(self,
        ...
        return PartitionAuxFunction.forward(
            ...
            self.die_size_x, self.die_size_y, self.row_height, pin_pos,
            self.terminal_instert_flag, self.terminal_legalize_flag,
