 ...
 * @LastEditTime: 2025-07-23 15:40:35
 * @FilePath:
 * /D2D-placer/placer/ops/macro_utilization_balance/src/macro_utilization_balance.cpp
 * @Description:
 */
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("macro_utilization_balance",
        &PLACER_NAMESPACE::macro_utilization_balance_forward,
