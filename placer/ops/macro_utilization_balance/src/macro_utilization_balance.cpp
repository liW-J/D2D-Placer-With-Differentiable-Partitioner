 ...
 * @LastEditTime: 2025-07-23 11:28:02
 * @FilePath: /D2D-placer/placer/ops/macro_utilization_balance/src/macro_utilization_balance.cpp
 * @Description: 
 */
...
template <typename T>
void macroUtilizationBalanceLauncher(
...
at::Tensor macro_utilization_balance_forward(
  ...
  DREAMPLACE_DISPATCH_FLOATING_TYPES(
      node_size_x, "macroUtilizationBalanceLauncher", [&] {
        macroUtilizationBalanceLauncher<scalar_t>(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("macro_utilization_balance", &PLACER_NAMESPACE::macro_utilization_balance_forward,
        "macro_utilization_balance_forward");
}
