...
import ops.weighted_average_wirelength_3d.weighted_average_wirelength_3d as weighted_average_wirelength_3d
...
class PlaceObj3D(nn.Module):
    ...
    def __init__(self, density_weight, params, placedb, data_collections,
        ...
        """
        super(PlaceObj3D, self).__init__()
    ...
    def build_weighted_average_wl(self, params, placedb, data_collections,
        ...
        wirelength_for_pin_op = weighted_average_wirelength_3d.WeightedAverageWirelength3D(
